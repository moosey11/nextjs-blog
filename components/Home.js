    ...
    <script src="js/common/modernizr.js"></script>
        ...
        <div class="content">
            <div class="container">
                    ...
                    <div class="sidebar col-sm-4">
                        ...
                        <h2 class="section-title">Last minute deals</h2> 
                            ...
                            <li class="col-md-12">
                                ...
                                <h4><a href="blog-detail.html">Private Beach Lossarnach, Eriado</a></h4>
                            </li>
                            <li class="col-md-12">
                                <div class="image">
                                    <a href="blog-detail.html"></a>
                                ...
                                <h4><a href="blog-detail.html">Mountain viewsHyarnustar, Rhovanion</a></h4>
                            </li>
                            <li class="col-md-12">
                                <div class="image">
                                    <a href="blog-detail.html"></a>
                                ...
                                <h4><a href="blog-detail.html">Heart of the villageMinhiriath, Eriador</a></h4>
                            </li>
                            <li class="col-md-12">
                                <div class="image">
                                    <a href="blog-detail.html"></a>
                ...
                <h4><a href="blog-detail.html">The city lifeWest Beleriand, Mordor</a></h4>
                            </li></ul>
